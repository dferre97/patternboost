...
const NUM_INITIAL_EMPTY_OBJECTS = 500000 #on the first run, this many rollouts will be done from empty graphs/objects
const FINAL_DATABASE_SIZE = 50000 # Size of learning set
const TARGET_DB_SIZE = 500000 # Database size will never be twice bigger than that
